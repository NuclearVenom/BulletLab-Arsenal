...
- Removed 50 ROS/simulation-only elements (gazebo, transmission, ros2_control)
- Resolved and rewrote mesh references: 28 mesh paths were updated to ../meshes/<name>, and the package:// URI scheme was removed from mesh references
