...
| Authors | TODO |
| Tags | `ros`, `gazebo`, `simulation`, `robotics`, `unitree`, `low-level-control` |
...
|----|-------------|------------|
| `go2_description` | Go2 Description | `urdf/go2_description.urdf`  **(default)** |
...
robot = Robot.load("go2_description")

# Load a specific variant
robot = Robot.load("go2_description/go2_description")
```
