...
| Tags | `ros`, `gazebo`, `robot-description`, `simulation`, `unitree` |
...
|----|-------------|------------|
| `dex3_1_l` | Dex3 1 L | `urdf/dex3_1_l.urdf`  **(default)** |
| `dex3_1_r` | Dex3 1 R | `urdf/dex3_1_r.urdf` |
...
robot = Robot.load("dex3_1")

# Load a specific variant
robot = Robot.load("dex3_1/dex3_1_l")
```
