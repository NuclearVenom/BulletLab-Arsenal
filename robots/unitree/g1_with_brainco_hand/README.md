...
|----|-------------|------------|
| `g1_29dof_mode_15_brainco_hand` | G1 29dof mode 15 brainco hand | `urdf/g1_29dof_mode_15_brainco_hand.urdf`  **(default)** |
...
robot = Robot.load("g1_with_brainco_hand")

# Load a specific variant
robot = Robot.load("g1_with_brainco_hand/g1_29dof_mode_15_brainco_hand")
```
